    ...
    <div className="flex flex-col gap-10 overflow-x-hidden">
      ...
      >
        ...
        <motion.div variants={gridSquareVarients} className="bg-slate-800 aspect-square rounded-lg justify-center flex items-center gap-10">
          ...
          <motion.div className='w-1/3 h-1/3 bg-orange-500 rounded-3xl cursor-grap' drag dragConstraints={{top:-125, right:125, bottom:125, left:-125}} dragTransition={{bounceStiffness:600, bounceDamping:10}}></motion.div>
